      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="flex flex-col gap-6 lg:items-start">
            ...
            <Link href={ctaHref} className="btn btn-shine bg-[#D32F2F] text-white px-10 py-4 rounded-xl font-bold hover:bg-white hover:text-[#D32F2F] hover:-translate-y-0.5 transition-all text-sm self-start shadow-xl shadow-[#D32F2F]/20">
              {cta}
            </Link>
          </div>
        </div>
