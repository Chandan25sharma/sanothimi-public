...
const STATS = [
  ...
  { target: 1, suf: '',   labelKey: 'h2.stat.institutions' as TranslationKey, delay: 150,
    icon: 'M3 21h18M5 21V7l8-4v18m4 0V11l4 2v8M9 9h.01M9 12h.01M9 15h.01' },
  { target: 50, suf: '+',   labelKey: 'h2.stat.users' as TranslationKey,   delay: 300,
    icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z' },
  { target: 2026, suf: '',  labelKey: 'h2.stat.digitalNepal' as TranslationKey, delay: 450,
