...
export const metadata: Metadata = {
  ...
  icons: {
    ...
    shortcut: '/sanothimi-logo0icon.png',
  },
  openGraph: {
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <head>
        <link rel="icon" type="image/png" href="/sanothimi-logo0icon.png" />
        <link rel="shortcut icon" href="/sanothimi-logo0icon.png" />
        <link rel="apple-touch-icon" href="/sanothimi-logo0icon.png" />
        ...
        <Script
          async
          src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1823083524417545"
